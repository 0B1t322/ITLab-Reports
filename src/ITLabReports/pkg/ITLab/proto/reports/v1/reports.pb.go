...
const (
	...
	ReportsServiceErrors_REPORT_ALREADY_PAID ReportsServiceErrors = 1
)
...
func (x *PaidForReportReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PaidForReportReq) ProtoMessage() {}

func (x *PaidForReportReq) ProtoReflect() protoreflect.Message {
	mi := &file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PaidForReportReq.ProtoReflect.Descriptor instead.
func (*PaidForReportReq) Descriptor() ([]byte, []int) {
	return file_rtuitlab_itlab_reports_v1_reports_proto_rawDescGZIP(), []int{8}
}

func (x *PaidForReportReq) GetReportId() string {
	if x != nil {
		return x.ReportId
	}
	return ""
...
type PaidForReportResp struct {
	...
	// Types that are assignable to Result:
	//
	//	*PaidForReportResp_Empty
	//	*PaidForReportResp_Error
	Result isPaidForReportResp_Result `protobuf_oneof:"result"`
}

func (x *PaidForReportResp) Reset() {
	*x = PaidForReportResp{}
	if protoimpl.UnsafeEnabled {
...
func (x *PaidForReportResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PaidForReportResp) ProtoMessage() {}

func (x *PaidForReportResp) ProtoReflect() protoreflect.Message {
	mi := &file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[9]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PaidForReportResp.ProtoReflect.Descriptor instead.
func (*PaidForReportResp) Descriptor() ([]byte, []int) {
	return file_rtuitlab_itlab_reports_v1_reports_proto_rawDescGZIP(), []int{9}
}

func (m *PaidForReportResp) GetResult() isPaidForReportResp_Result {
	if m != nil {
		return m.Result
	}
	return nil
...
func (x *PaidForReportResp) GetEmpty() *emptypb.Empty {
	if x, ok := x.GetResult().(*PaidForReportResp_Empty); ok {
		return x.Empty
	}
	return nil
}

func (x *PaidForReportResp) GetError() ReportsServiceErrors {
	if x, ok := x.GetResult().(*PaidForReportResp_Error); ok {
		return x.Error
	}
	return ReportsServiceErrors_REPORT_NOT_FOUND
}

type isPaidForReportResp_Result interface {
	isPaidForReportResp_Result()
}

type PaidForReportResp_Empty struct {
	Empty *emptypb.Empty `protobuf:"bytes,1,opt,name=empty,proto3,oneof"`
}

type PaidForReportResp_Error struct {
	Error ReportsServiceErrors `protobuf:"varint,2,opt,name=error,proto3,enum=rtuitlab.itlab.reports.v1.ReportsServiceErrors,oneof"`
}

func (*PaidForReportResp_Empty) isPaidForReportResp_Result() {}

func (*PaidForReportResp_Error) isPaidForReportResp_Result() {}
...
func (x *GetReportsPaginatedReq_FilterParams) Reset() {
	*x = GetReportsPaginatedReq_FilterParams{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[10]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *GetReportsPaginatedReq_OrderParams) Reset() {
	*x = GetReportsPaginatedReq_OrderParams{}
	if protoimpl.UnsafeEnabled {
		mi := &file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[11]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_rtuitlab_itlab_reports_v1_reports_proto_rawDesc = []byte{
	...
	0x74, 0x49, 0x6d, 0x70, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x52, 0x65, 0x71, 0x12,
	0x1b, 0x0a, 0x09, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x08, 0x72, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x64, 0x22, 0x91, 0x01, 0x0a,
	0x18, 0x47, 0x65, 0x74, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x49, 0x6d, 0x70, 0x6c, 0x65, 0x6d,
	0x65, 0x6e, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x12, 0x22, 0x0a, 0x0b, 0x69, 0x6d, 0x70,
	0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00,
	0x52, 0x0b, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x47, 0x0a,
	...
	,
	...
	,
	...
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2e, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x52, 0x05, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x12,
	0x3b, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	,
	...
	0x45, 0x0a, 0x14, 0x52, 0x65, 0x70, 0x6f, 0x72, 0x74, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x12, 0x14, 0x0a, 0x10, 0x52, 0x45, 0x50, 0x4f, 0x52,
	0x54, 0x5f, 0x4e, 0x4f, 0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x00, 0x12, 0x17, 0x0a,
	0x13, 0x52, 0x45, 0x50, 0x4f, 0x52, 0x54, 0x5f, 0x41, 0x4c, 0x52, 0x45, 0x41, 0x44, 0x59, 0x5f,
	0x50, 0x41, 0x49, 0x44, 0x10, 0x01, 0x32, 0xb7, 0x04, 0x0a, 0x07, 0x52, 0x65, 0x70, 0x6f, 0x72,
	...
	,
...
var file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_rtuitlab_itlab_reports_v1_reports_proto_goTypes = []interface{}{
	...
	(*PaidForReportReq)(nil),                            // 12: rtuitlab.itlab.reports.v1.PaidForReportReq
	(*PaidForReportResp)(nil),                           // 13: rtuitlab.itlab.reports.v1.PaidForReportResp
	(*GetReportsPaginatedReq_FilterParams)(nil),         // 14: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.FilterParams
	(*GetReportsPaginatedReq_OrderParams)(nil),          // 15: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.OrderParams
	(*types.Report)(nil),                                // 16: rtuitlab.itlab.reports.Report
	(*shared.Pagination)(nil),                           // 17: rtuitlab.itlab.shared.Pagination
	(*shared.PaginationInfo)(nil),                       // 18: rtuitlab.itlab.shared.PaginationInfo
	(*emptypb.Empty)(nil),                               // 19: google.protobuf.Empty
	(*timestamppb.Timestamp)(nil),                       // 20: google.protobuf.Timestamp
	(shared.Ordering)(0),                                // 21: rtuitlab.itlab.shared.Ordering
}
var file_rtuitlab_itlab_reports_v1_reports_proto_depIdxs = []int32{
	...
	16, // 1: rtuitlab.itlab.reports.v1.GetReportResp.report:type_name -> rtuitlab.itlab.reports.Report
	...
	16, // 4: rtuitlab.itlab.reports.v1.GetReportsResp.reports:type_name -> rtuitlab.itlab.reports.Report
	14, // 5: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.filter_params:type_name -> rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.FilterParams
	15, // 6: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.order_params:type_name -> rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.OrderParams
	17, // 7: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.pagination:type_name -> rtuitlab.itlab.shared.Pagination
	16, // 8: rtuitlab.itlab.reports.v1.GetReportsPaginatedResp.reports:type_name -> rtuitlab.itlab.reports.Report
	18, // 9: rtuitlab.itlab.reports.v1.GetReportsPaginatedResp.pagination_info:type_name -> rtuitlab.itlab.shared.PaginationInfo
	19, // 10: rtuitlab.itlab.reports.v1.PaidForReportResp.empty:type_name -> google.protobuf.Empty
	0,  // 11: rtuitlab.itlab.reports.v1.PaidForReportResp.error:type_name -> rtuitlab.itlab.reports.v1.ReportsServiceErrors
	20, // 12: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.FilterParams.date_begin:type_name -> google.protobuf.Timestamp
	20, // 13: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.FilterParams.date_end:type_name -> google.protobuf.Timestamp
	2,  // 14: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.FilterParams.paid_state:type_name -> rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.FilterParams.PaidState
	3,  // 15: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.OrderParams.field:type_name -> rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.OrderParams.OrderFields
	21, // 16: rtuitlab.itlab.reports.v1.GetReportsPaginatedReq.OrderParams.ordering:type_name -> rtuitlab.itlab.shared.Ordering
	4,  // 17: rtuitlab.itlab.reports.v1.Reports.GetReportImplementer:input_type -> rtuitlab.itlab.reports.v1.GetReportImplementerReq
	6,  // 18: rtuitlab.itlab.reports.v1.Reports.GetReport:input_type -> rtuitlab.itlab.reports.v1.GetReportReq
	8,  // 19: rtuitlab.itlab.reports.v1.Reports.GetReports:input_type -> rtuitlab.itlab.reports.v1.GetReportsReq
	10, // 20: rtuitlab.itlab.reports.v1.Reports.GetReportsPaginated:input_type -> rtuitlab.itlab.reports.v1.GetReportsPaginatedReq
	12, // 21: rtuitlab.itlab.reports.v1.Reports.PaidForReport:input_type -> rtuitlab.itlab.reports.v1.PaidForReportReq
	5,  // 22: rtuitlab.itlab.reports.v1.Reports.GetReportImplementer:output_type -> rtuitlab.itlab.reports.v1.GetReportImplementerResp
	7,  // 23: rtuitlab.itlab.reports.v1.Reports.GetReport:output_type -> rtuitlab.itlab.reports.v1.GetReportResp
	9,  // 24: rtuitlab.itlab.reports.v1.Reports.GetReports:output_type -> rtuitlab.itlab.reports.v1.GetReportsResp
	11, // 25: rtuitlab.itlab.reports.v1.Reports.GetReportsPaginated:output_type -> rtuitlab.itlab.reports.v1.GetReportsPaginatedResp
	13, // 26: rtuitlab.itlab.reports.v1.Reports.PaidForReport:output_type -> rtuitlab.itlab.reports.v1.PaidForReportResp
...
func file_rtuitlab_itlab_reports_v1_reports_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PaidForReportResp); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
	...
	file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[9].OneofWrappers = []interface{}{
		(*PaidForReportResp_Empty)(nil),
		(*PaidForReportResp_Error)(nil),
	}
	file_rtuitlab_itlab_reports_v1_reports_proto_msgTypes[10].OneofWrappers = []interface{}{}
	type x struct{}
